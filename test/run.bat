...
..\Este\extLibs\pin-3.18-98332-gaebd7b1e6-msvc-windows\pin.exe -follow_execv -pause_tool %1 -t64 Este-64.dll -t Este-32.dll -config-file este-config.toml -- %RUN_COMMAND%
